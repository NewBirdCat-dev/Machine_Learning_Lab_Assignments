...
predictors = data.drop('Sales', axis=1).columns
target = data['Sales']
...
for predictor in predictors:
    ...
    for i, degree in enumerate(degrees):
        ...
        plt.title(f"Residual errors for Degree {degree} with Predictor {predictor}")
    ...
    for i, degree in enumerate(degrees):
        ...
        axes[i//2, i%2].set_title(f'Histogram Plot of Residuals for Degree {degree} with Predictor {predictor}')
    ...
    for i, degree in enumerate(degrees):
        ...
        axes[i//2, i%2].set_title(f'Q-Q Plot of Residuals for Degree {degree} with Predictor {predictor}')
    ...
    for i, degree in enumerate(degrees):
        ...
        axes[i//2, i%2].set_title(f'Box Plot of Residuals for Degree {degree} with Predictor {predictor}')
    ...
    for i, degree in enumerate(degrees):
        ...
        plt.title(f'Actual vs. Predicted Sales for Degree {degree} with Predictor {predictor}')
    ...
    plt.title(f'Model Complexity vs. Performance for Predictor {predictor}')
